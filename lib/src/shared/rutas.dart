...
final rutas = {
  ...
  Rutas.actualArre.name: (context) =>  RentersCurrentDTScreen(),
  Rutas.historialArre.name: (context) =>  RentersHistoryDTScreen(),
  Rutas.pagosPendienteArre.name: (context) =>  PendingPaymentsDTScreen(),
  Rutas.estadoCuenta.name: (context) =>  AccountStatusDTScreen(),
  Rutas.viviendasOcupadas.name: (context) =>  OccupiedHousingDTScreen(),
  Rutas.cuentasPagarServicios.name: (context) =>  AccounstToPayServicesDTScreen(),
  Rutas.facturaDanoPropiedad.name: (context) =>  PropertyDamageDTScreen(),
